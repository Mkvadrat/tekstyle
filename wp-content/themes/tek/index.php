...
<div class="col-md-3 hidden-sm hidden-xs">
    ...
    ?>
</div><div class="content-area col-md-9 col-sm-12 col-xs-12">
        <div class="entry-header clearfix" style="">
            <div class="entry-content">
                <div class="stm_post_info">
                    <h1 class="h3">компания "ТЭК Стиль"</h1>
                    <button type="button" class="pull-right mail-button" data-toggle="modal" data-target=".mail-modal">Написать письмо</button>
                    <p>Торгово-Экономическая Компания "Стиль"</p>
                </div>
            </div>
        </div>
		<?php echo $content_before; ?>
			...
			<?php if( have_posts() ){
				...
				?>
			<?php }else{ ?>
				<p><?php _e( 'No result has been found. Please check for correctness.', STM_DOMAIN ); ?></p>
			<?php } ?>
