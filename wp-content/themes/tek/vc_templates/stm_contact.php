...
<div class="stm_contact<?php echo esc_attr( $css_class ); ?> clearfix">
	...
	<div class="stm_contact_info">
		...
		<?php } ?>
		<?php if( $email ){ ?>
			<div class="stm_contact_row"><?php _e( 'Email: ', STM_DOMAIN ); ?><?php echo balanceTags( $email, true ); ?></div>
		<?php } ?>
		<?php if( $skype ){ ?>
			<div class="stm_contact_row"><?php _e( 'Skype: ', STM_DOMAIN ); ?><?php echo balanceTags( $skype, true ); ?></div>
		<?php } ?>
	</div>
</div>