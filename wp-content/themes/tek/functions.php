...
if ( ! function_exists( 'stm_theme_setup' ) ) {
	...
	function stm_theme_setup() {
		...
		register_nav_menus(
			array(
				'primary_menu'   => __( 'Top Menu', STM_DOMAIN ),
                'left_menu'   => __( 'Left Menu', STM_DOMAIN )
			)
		);

		register_sidebar(
			array(
				'name'          => __( 'Default Sidebar', STM_DOMAIN ),
				'id'            => 'default',
				'description'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Shop Sidebar', STM_DOMAIN ),
				'id'            => 'shop',
				'description'   => '',
