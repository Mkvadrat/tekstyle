...
class Stm_Instagram_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			'instagram', // Base ID
			__( 'Instagram', STM_DOMAIN ), // Name
			array( 'description' => __( 'Instagram widget', STM_DOMAIN ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['clientId'] ) ) {
			...
			if($instance['instagramToken']){
				...
				_e( 'Error Instagram Token', STM_DOMAIN );
			}

		} else {
			_e( 'Error Client Id', STM_DOMAIN );
		}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'posts' ) ); ?>"><?php _e( 'Number of posts to show:', STM_DOMAIN ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'cache' ) ); ?>"><?php _e( 'Cache: (h)', STM_DOMAIN ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'clientId' ) ); ?>"><?php _e( 'Client Id:', STM_DOMAIN ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'secret' ) ); ?>"><?php _e( 'Secret:', STM_DOMAIN ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'token' ) ); ?>"><?php _e( 'Token:', STM_DOMAIN ); ?></label>
