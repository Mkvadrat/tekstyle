<div id="frontend_customizer" style="left: -276px;">
    <div class="customizer_wrapper">
	    ...
	    <h3><?php _e('Header', STM_DOMAIN); ?></h3>
        <div class="customizer_element">
            <select id="header_style">
	            <option value="">Default</option>
	            <option id="header_style_transparent" value="?header_demo=transparent">Transparent</option>
	            <option id="header_style_dark" value="?header_demo=dark&top_bar=show">Dark</option>
	            <option id="header_style_white" value="?header_demo=white&top_bar=show">White</option>
            </select>
        </div>

        <h3><?php _e('Navigation', STM_DOMAIN); ?></h3>
        <div class="customizer_element">
	    ...
	    <h3><?php _e('Layout', STM_DOMAIN); ?></h3>
	    <div class="customizer_element">
		    <div class="stm_switcher" id="site_layout">
			    <div class="switcher_label disable"><?php _e('Wide', STM_DOMAIN); ?></div>
			    <div class="switcher_nav"></div>
			    <div class="switcher_label enable"><?php _e('Boxed', STM_DOMAIN); ?></div>
		    </div>
	    </div>

	    <div class="customizer_bg_image" style="display: none;">
		    <h3><?php _e('Background Image', STM_DOMAIN); ?></h3>
		    <div class="customizer_element">
        ...
        <h3><?php _e('Color Skin', STM_DOMAIN); ?></h3>
        <div class="customizer_element">
        ...
        <hr/>
        <button id="customizer_reset" class="customizer_reset_button"><?php _e('Reset', STM_DOMAIN); ?></button>
    </div>
